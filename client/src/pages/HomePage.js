...
const HomePage = () => {
  ...
  return (
    <section className="min-h-screen py-8 lg:py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900">
                ...
                {pagination.page < pagination.pages && (
                  <div className="flex justify-center pt-6">
                    <button 
                      ...
                      disabled={loading}
                      className="px-6 py-2.5 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
